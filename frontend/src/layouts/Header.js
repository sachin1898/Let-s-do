...
const Header = () => {
    ...
    return(
        <header className="sticky bg-black w-full top-0">
          <nav className="flex py-1 border-b-2 text-white">
            <span className="text-3xl font-medium ml-3 md:ml-40">Let's&nbsp;do</span>
            <ul className="w-full flex items-center flex-wrap justify-end gap-4">
              {
                (user)?(
                    <>
                        <li className="text-sm lg:text-xl font-medium" style={{cursor:'pointer'}}>{user.name}</li>
                    ...
                    <>
                        <li className="text-sm lg:text-xl font-medium" style={{cursor:'pointer'}}>
                            <Link to="/signup">Signup</Link>
                        </li>
                        <li className="text-sm lg:text-xl mr-3 md:mr-10 lg:mr-20  font-medium" style={{cursor:'pointer'}}>
